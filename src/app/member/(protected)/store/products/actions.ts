...
const productSchema = z.object({
  ...
  image_url:           z.string().max(500).refine((v) => v === "" || /^https?:\/\//i.test(v), "URL ต้องเป็น https://").or(z.literal("")),
  tiktok_product_url:  z.string().max(500).refine((v) => v === "" || /^https?:\/\//i.test(v), "URL ต้องเป็น https://").or(z.literal("")),
